package com.appvenda.persistence;
...
public class DataBaseConnection {
	...
	private EntityManagerFactory getFactory() {
		...
		propriedades.put("hibernate.connection.url","jdbc:mysql://127.0.0.1:3306/appvenda");
		...
		propriedades.put("hibernate.default_schema","appvenda");
		
		return Persistence.createEntityManagerFactory("appvenda",propriedades);
	}
}
